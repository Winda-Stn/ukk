                        ...
                        <tbody>
                            @foreach ($transaksi as $transaksi)
                                <tr>
                                    ...
                                    <td class="text-start"><strong>{{ $transaksi->nama_pelanggan ?? 'N/A' }}</strong></td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-info text-white p-2">
                                            Rp. {{ number_format($transaksi->ppn, 2, ',', '.') }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-success text-white p-2">
                                            Rp. {{ number_format($transaksi->total_akhir, 2, ',', '.') }}
                                        </span>
                                    </td>
                                    <td>
                                        <!-- Tombol Lihat Detail -->
                                        ...
                                        <!-- Tombol Edit (Pastikan view 'transaksi-penjualan.edit' sudah ada) -->
